(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@bit/valor-software.ngx-bootstrap.internal.positioning/positioning', ['exports', '@angular/core', '@angular/common', 'rxjs'], factory) :
    (global = global || self, factory((global.bit = global.bit || {}, global.bit.internal = global.bit.internal || {}, global.bit.internal.positioning = global.bit.internal.positioning || {}, global.bit.internal.positioning.positioning = {}), global.ng.core, global.ng.common, global.rxjs));
    ...
    function computeAutoPlacement(placement, refRect, target, host, allowedPositions, boundariesElement, padding) {
         ...
         * @return {?}
         */
        function (key) { return (__assign$1({ key: key }, rects[key], { area: getArea(rects[key]) })); }))
            .sort((/**
         * @param {?} a
         * @param {?} b
         * @return {?}
    ...
    function flip(data) {
        ...
        if (!isModifierEnabled(data.options, 'flip')) {
            data.offsets.target = __assign$2({}, data.offsets.target, getTargetOffsets(data.instance.target, data.offsets.host, data.placement));
            return data;
        }
        /** @type {?} */
    ...
    function preventOverflow(data) {
        ...
        function (placement) {
            side = ['left', 'top']
                ...
                ? 'primary'
                : 'secondary';
            data.offsets.target = __assign$3({}, data.offsets.target, ((/** @type {?} */ (check)))[side](placement));
        }));
        return data;
    }
    ...
    function shift(data) {
        ...
        if (shiftvariation) {
            ...
            data.offsets.target = __assign$4({}, target, ((/** @type {?} */ (shiftOffsets)))[shiftvariation]);
        }
        return data;
    }
    ...
    var PositioningService = /** @class */ (function () {
        function PositioningService(rendererFactory, platformId) {
            ...
            if (common.isPlatformBrowser(platformId)) {
                this.triggerEvent$ = rxjs.merge(rxjs.fromEvent(window, 'scroll'), rxjs.fromEvent(window, 'resize'), 
                /* tslint:disable-next-line: deprecation */
                rxjs.of(0, rxjs.animationFrameScheduler), this.update$$);
...
//# sourceMappingURL=bit-internal.positioning-positioning.umd.js.map
